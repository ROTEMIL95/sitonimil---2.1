  ...
  return (
    <section className="max-w-3xl mx-auto px-4 py-12">
      <div className="bg-white shadow-md rounded-xl p-6 sm:p-10">
        <h1 className="text-3xl font-bold mb-6 text-blue-700 text-center sm:text-right">
          מדיניות פרטיות
        </h1>
        ...
        <div className="space-y-8">
          <section>
            <h2 className="text-xl font-semibold text-blue-600 mb-2">1. איסוף מידע</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-blue-600 mb-2">2. שימוש במידע</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-blue-600 mb-2">3. אבטחת מידע</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-blue-600 mb-2">4. שיתוף מידע</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-blue-600 mb-2">5. זכויות המשתמש</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-blue-600 mb-2">6. עוגיות</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-blue-600 mb-2">7. שינויים במדיניות</h2>
            <p className="text-gray-700">
          ...
          <section>
            <h2 className="text-xl font-semibold text-blue-600 mb-2">8. יצירת קשר</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-blue-600 mb-2">9. תאריך עדכון אחרון</h2>
