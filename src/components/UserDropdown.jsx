  ...
  return (
    <div className="relative">
      ...
      >
        <span className="mr-3 overflow-hidden rounded-full h-11 w-11">
          <Avatar className="h-12 w-12">
            {user.logo_url || user.avatar_url ? (
              <AvatarImage 
                src={user.logo_url || user.avatar_url}
        ...
        <span className="block mr-1 font-medium text-sm">{user.full_name}</span>
        <svg
      ...
      {isOpen && (
        <div className="absolute right-0 mt-[17px] flex w-[260px] flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark" dir="rtl">
          <div>
          ...
          <Button
            variant="ghost"
            className="flex items-center gap-3 px-3 py-2 mt-3 font-medium text-gray-700 rounded-lg group text-sm hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300 w-full"
            onClick={() => {
              closeDropdown();
              onLogout();
            }}
